...
ZBUS_CHANNEL(sensor_data,                  /* Name */
           ...
           ZBUS_CHANNEL_SUBSCRIBERS(core), /* Subscribers */
...
ZBUS_CHANNEL(net_pkt,                      /* Name */
           ...
           ZBUS_CHANNEL_SUBSCRIBERS(net),  /* Subscribers */
           ZBUS_INIT(.y = false, .x = ' ') /* Initial value */
)
...
ZBUS_CHANNEL(start_measurement,                            /* Name */
           ...
           ZBUS_CHANNEL_SUBSCRIBERS(peripheral, critical), /* Subscribers */
